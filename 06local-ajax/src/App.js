...
class App extends Component {
  ...
  state = {
    article: { title: "Welcom", desc: "Hello, Ajax..!!" },
  };
  render() {
    return (
      <div className="App">
      ...
      listTag.push(
        ...
        <li key={li.id}>
          {/* 이벤트 객체를 통해 값을 전달하기 위해 data-id속성을 추가한다.
           data-id={li.id}에 추가한 값이 바로 아래에서 사용하는 e.target.dataset.id 이다.*/}
          <a
            href={li.id}
            data-id={li.id}
            onClick={(e) => {
